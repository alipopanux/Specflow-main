...
{
    public class OffsetDateValueTwoCombinedRetriever : IValueRetriever
    {
        ...
        /// </example>
        public OffsetDateValueTwoCombinedRetriever(
    ...
    public class OffsetDateBuilder
    {
        public TimesOffsetType Type { get; set; }
        public int TimesOffset { get; set; }
    }
}
